...
<div className=' p-1   col-span-1 '>
  <Image src={comment?.author?.image||"/img"} height={70} width={40} unoptimized alt="" className=" mr-3  rounded-md border-white/10 border-2 " />
</div>
...
<p className=' text-[10px] font-extralight mb-2   '>  {dayjs(comment?.createdAt).fromNow()} </p>
    ...
    <p className=' text-sm md:text-md  text-white/95 '>{comment?.caption}</p>
</div>
