...
const PostContainer = ({
  ...
  return (
    <div className="   grid-row-10 grid w-full grid-cols-10  rounded-sm border-b-2  max-w-xl    border-white/10 p-2   ">
      ...
      <div className=" grid-rows-10 col-span-8  grid  sm:col-span-9">
        ...
        <div className="relative   ">
          {tweet?.img && (
            <Image
              src={tweet?.img}
              className=" w-full  rounded  border-2 border-white/10 md:aspect-[4/5]  "
              unoptimized
              alt="Postimg"
              width={200}
              height={100}
