...
const SideBar = () => {
  ...
  return (
    ...
    <div className=' hidden md:sticky top-10 my-4 gap-3   px-2   text-2xl  py-4 h-fit md:grid   grid-cols-3 md:grid-cols-1 rounded-sm  '>
     ...
     <div className="  flex items-center justify-start "><Link href={"/profile"}><h1 className={asPath==='/profile'?" text-[hsl(280,100%,70%)]":""} ><CgProfile/></h1></Link><h1 className=" mx-2  hidden xl:block text-xl" >Profile</h1></div>
